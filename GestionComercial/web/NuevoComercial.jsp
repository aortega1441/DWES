    ...
    <body>
        ...
        <div class="container text-center" style="margin-bottom: 1em">
            ...
            <div class="row">
                ...
                <div class="col"></div>
                <form method="post" action="ListaComerciales"><div class="col"><button>Listado de comerciales</button></form><br><br>
                    <form method="post" action="NuevoComercial.jsp"><button>Alta de comercial</button></form></div>
        ...
        <div class="text-center">
            ...
            <form method="post" action="ValidaComercial">
                ...
                Salario
                <input type="text" name="salario" value="" required/> 
                ...
                Número de hijos
                <input type="text" name="hijos" value="" required/> 
