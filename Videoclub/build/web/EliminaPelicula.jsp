...
<html>
    ...
    <body>
        ...
        <header style="background-color: darkkhaki; padding-bottom: 1em; padding-top: 1em; margin-bottom: 2em"><h1 style="color: white; text-align: center">Eliminar una película</h1></header>

        <div class="container">

            <div class="text-center">            

                <form method="post" action="ValidaElimina">

                    Seleccione la película que desea consultar
                    <select name="peliculaEliminar">
                        <%                           
