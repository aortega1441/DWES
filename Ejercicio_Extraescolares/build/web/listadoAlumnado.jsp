<%-- 
    Document   : listadoAlumnado.jsp
    Created on : 6 oct. 2022, 20:38:38
    Author     : vecto
--%>
    ...
    <body>
        ...
        <form action="">
            ...
            <table>
                ...
                <%
                    for (ActividadExtraescolar actividad : lista) {
                        if (actividad.getDestino().equals("alumnado")) {
                %>
            ...
            <h1>EL LISTADO ESTA VACIO<h1>
                    ...
                    <button type="button" name="profesorado" onClick="location.href = 'listado.jsp';">Ver actividades del profesorado</button>
